                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  <h1>Cars</h1>
                                  <p>Whether you're importing or exporting a car, motorcycle, or any other type of vehicle, our expert team ensures safe, reliable, and efficient shipping to any destination worldwide.</p>
                              </div>
                          </div>
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="655" height="340" src="<?php echo ASSET_URL; ?>img/export-delivery-countries-america.jpg" class="attachment-full size-full" alt="Export to America" decoding="async" fetchpriority="high" srcset="<?php echo ASSET_URL; ?>img/export-delivery-countries-america.jpg 655w, <?php echo ASSET_URL; ?>img/export-delivery-countries-america-300x156.jpg 300w" sizes="(max-width: 655px) 100vw, 655px" />
                              </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      <h2>Import Your Car from America, Canada, or Anywhere in the World!</h2>
                                      <p>At Vaga Divertida, we specialize in making the process of importing your car from America, Canada, or any other country as simple and convenient as possible. Whether you're a private collector, enthusiast of exotic cars, or in search of a classic model, we are your trusted partner for importing vehicles internationally.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
