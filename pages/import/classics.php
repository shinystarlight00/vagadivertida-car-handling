                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-6">
                                  <div class="inner image h-100">
                                      <img width="900" height="400" src="<?php echo ASSET_URL; ?>img/classic.jpg" class="attachment-full size-full" alt="" decoding="async" srcset="<?php echo ASSET_URL; ?>img/classic.jpg 900w, <?php echo ASSET_URL; ?>img/classic-300x133.jpg 300w, <?php echo ASSET_URL; ?>img/classic-768x341.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" />
                                  </div>
                              </div>
                          </div>
                      </div>
