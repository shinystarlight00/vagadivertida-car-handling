                  ...
                  <div class="container">
                      <div class="row">
                          ...
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="945" height="400" src="<?php echo ASSET_URL; ?>img/export-vehicle-middle-east-header.jpg" class="attachment-full size-full" alt="Export vehicle middle east" decoding="async" fetchpriority="high" srcset="<?php echo ASSET_URL; ?>img/export-vehicle-middle-east-header.jpg 945w, <?php echo ASSET_URL; ?>img/export-vehicle-middle-east-header-300x127.jpg 300w, <?php echo ASSET_URL; ?>img/export-vehicle-middle-east-header-768x325.jpg 768w" sizes="(max-width: 945px) 100vw, 945px" />
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <section class="page-section content p-t-xl img-left">
                      <div class="container">
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="inner image h-100">
                                      <img width="900" height="400" src="<?php echo ASSET_URL; ?>img/Ocean-freight.jpg" class="attachment-full size-full" alt="" decoding="async" srcset="<?php echo ASSET_URL; ?>img/Ocean-freight.jpg 900w, <?php echo ASSET_URL; ?>img/Ocean-freight-300x133.jpg 300w, <?php echo ASSET_URL; ?>img/Ocean-freight-768x341.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" />
                                  </div>
                              </div>
                              <div class="col-lg-6">
