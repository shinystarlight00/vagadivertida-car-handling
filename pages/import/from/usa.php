                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  <h1>Car Import from the USA with Vaga Divertida</h1>
                                  <p>Since 1995, Vaga Divertida has grown into one of the largest car importers in Europe, offering unparalleled experience and expertise in the import process. Our established presence provides several advantages of scale, including strong business relationships and global contacts, allowing us to offer the best service and competitive pricing for importing your vehicle.</p>
                          ...
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="945" height="400" src="<?php echo ASSET_URL; ?>img/import-usa.jpg" class="attachment-full size-full" alt="Export cars" decoding="async" fetchpriority="high" sizes="(max-width: 945px) 100vw, 945px" />
                              </div>
                          </div>
                      </div>
                  </div>
