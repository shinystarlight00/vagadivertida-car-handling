                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  ...
                                  <p><?php echo $data['australia-hero-desc']['description'] ?></p>
                              </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      ...
                                      <p><?php echo $data['australia-service-desc1']['description'] ?></p>
                                  </div>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      ...
                                      <p><?php echo $data['australia-service-desc2']['description'] ?></p>
                                  </div>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      ...
                                      <p><?php echo $data['australia-service-desc3']['description'] ?></p>
                                  </div>
                              </div>
                          </div>
                      </div>
