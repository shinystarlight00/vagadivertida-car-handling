                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  <h1>Australia</h1>
                                  <p>Importing to Australia is becoming an increasingly attractive option, and at Vaga Divertida, we offer flexible shipping solutions for transporting vehicles and goods to this dynamic market. We provide RoRo (Roll-on/Roll-off) and container transport options to Australia, ensuring that your shipment arrives safely and efficiently.</p>
                              </div>
                          </div>
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="900" height="400" src="<?php echo ASSET_URL; ?>img/Ocean-freight.jpg" class="attachment-full size-full" alt="" decoding="async" fetchpriority="high" srcset="<?php echo ASSET_URL; ?>img/Ocean-freight.jpg 900w, <?php echo ASSET_URL; ?>img/Ocean-freight-300x133.jpg 300w, <?php echo ASSET_URL; ?>img/Ocean-freight-768x341.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" />
                              </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      <h3>RoRo and Container Shipping Options:</h3>
                                      <p>Depending on your preferences and the nature of your cargo, we offer both RoRo and container shipping. RoRo is ideal for larger vehicles or those with wheels, while container shipping provides extra protection for smaller or more delicate goods.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <section class="page-section content p-t-xl">
                      <div class="container">
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      <h3>Expert Handling of Strict Australian Regulations:</h3>
                                      <p>Importing to Australia is subject to strict regulations, including compliance with vehicle standards, quarantine procedures, and customs rules. Our experienced team at Vaga Divertida is well-versed in these requirements and ensures that your import process complies with all regulations.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <section class="page-section content p-t-xl">
                      <div class="container">
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="inner text">
                                      <h3>Efficient and Reliable Transport:</h3>
                                      <p>We have a network of agents and logistics partners that ensure smooth operations and timely delivery to Australia. Whether you’re importing a vehicle, machinery, or other goods, we handle every aspect of the process.</p>
                                  </div>
                              </div>
                          </div>
                      </div>
