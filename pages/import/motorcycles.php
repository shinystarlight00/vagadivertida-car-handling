                  ...
                  <div class="container">
                      <div class="row">
                          ...
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="900" height="400" src="<?php echo ASSET_URL; ?>img/Motorcycles.jpg" class="attachment-full size-full" alt="" decoding="async" fetchpriority="high" srcset="<?php echo ASSET_URL; ?>img/Motorcycles.jpg 900w, <?php echo ASSET_URL; ?>img/Motorcycles-300x133.jpg 300w, <?php echo ASSET_URL; ?>img/Motorcycles-768x341.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" />
                              </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="inner text p-md h-100 pl-0">
                                      ...
                                      <p>Shipping your racing or vintage motorcycle to Europe is a breeze with Marlog Car Handling!</p>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="inner image h-100">
                                      <img width="900" height="400" src="<?php echo ASSET_URL; ?>img/Motorcycles.jpg-import.jpg" class="attachment-full size-full" alt="" decoding="async" srcset="<?php echo ASSET_URL; ?>img/Motorcycles.jpg-import.jpg 900w, <?php echo ASSET_URL; ?>img/Motorcycles.jpg-import-300x133.jpg 300w, <?php echo ASSET_URL; ?>img/Motorcycles.jpg-import-768x341.jpg 768w" sizes="(max-width: 900px) 100vw, 900px" />
                                  </div>
                              </div>
                          </div>
                      </div>
