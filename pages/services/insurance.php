                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="inner text p-md h-100 pl-0">
                                      ...
                                      <p><?php echo $data['insurance-service-desc']['description'] ?></p>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                              ...
                              <div class="col-lg-12">
                                  <div class="inner text p-md h-100 pl-0">
                                      ...
                                      <p>
                                        ...
                                        <p><?php echo $data['insurance-service-desc1']['description'] ?></p>
                                      </p>
                                      <p>
                                        <h4><?php echo $data['insurance-service-title2']['description'] ?></h4>
                                        <p><?php echo $data['insurance-service-desc2']['description'] ?></p>
                                      </p>
                                      <p>
                                        <h4><?php echo $data['insurance-service-title3']['description'] ?></h4>
                                        <p><?php echo $data['insurance-service-desc3']['description'] ?></p>
                                      </p>
                                      <p>
                                        <h4><?php echo $data['insurance-service-title4']['description'] ?></h4>
                                        <p><?php echo $data['insurance-service-desc4']['description'] ?></p>
                                      </p>
                                      <p>
