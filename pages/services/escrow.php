                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  <h1><?php echo $data['escrow-hero-title']['description'] ?></h1>
                          ...
                          <div class="col-xl-6 offset-xl-1 col-lg-6 offset-lg-1 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="945" height="400" src="<?php echo ASSET_URL.$data['escrow-hero-image']['url'] ?>" class="attachment-full size-full" alt="Escrow service" decoding="async" fetchpriority="high" sizes="(max-width: 945px) 100vw, 945px" />
                              </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="inner text p-md h-100 pl-0">
                                      <h2><?php echo $data['escrow-service-title']['description'] ?></h2>
                                      <p><?php echo str_replace('<br/>', '</p><p>', $data['escrow-service-desc']['description']) ?></p>
                                      
                                      <h4><?php echo $data['escrow-service-subtitle']['description'] ?></h4>
                                      <p><?php echo str_replace('<br/>', '</p><p>', $data['escrow-service-subdesc']['description']) ?></p>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="inner image h-100">
                                      <img width="750" height="750" src="<?php echo ASSET_URL.$data['escrow-service-image']['url'] ?>" class="attachment-full size-full" alt="Escrow Service" decoding="async" sizes="(max-width: 750px) 100vw, 750px" />
                                  </div>
                              </div>
                          </div>
                      </div>
