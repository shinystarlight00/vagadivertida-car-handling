                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  <h1>Registration procedure / Homologation</h1>
                                  <p>We also have a fully equipped, modern workshop, so we have all of the necessary facilities for technical conversion and a variety of inspections in-house.</p>
                              </div>
                          </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-6">
                                  <div class="inner image h-100">
                                      <img width="655" height="689" src="<?php echo ASSET_URL; ?>img/registration-procedure-left-image.jpg" class="attachment-full size-full" alt="Registration procedure / Homologation" decoding="async" srcset="<?php echo ASSET_URL; ?>img/registration-procedure-left-image.jpg 655w, <?php echo ASSET_URL; ?>img/registration-procedure-left-image-285x300.jpg 285w" sizes="(max-width: 655px) 100vw, 655px" />
                                  </div>
                              </div>
                          </div>
                      </div>
