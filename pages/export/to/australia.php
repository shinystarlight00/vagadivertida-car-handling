                  ...
                  <div class="container">
                      <div class="row">
                          ...
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="945" height="400" src="<?php echo ASSET_URL.$data['australia-hero-image']['url'] ?>" class="attachment-full size-full" alt="Export cars" decoding="async" fetchpriority="high" sizes="(max-width: 945px) 100vw, 945px" />
                              </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="inner text p-md h-100 pl-0">
                                      <h2><?php echo $data['australia-service-title']['description'] ?></h2>
                                      <p><?php echo str_replace('<br/>', '</p><p>', $data['australia-service-desc']['description']) ?></p>
                                      <ul>
                                          <li><?php echo str_replace('<br/>', '</li><li>', $data['australia-service-list']['description']) ?></li>
                                      </ul>
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="inner image h-100">
                                      <img width="655" height="560" src="<?php echo ASSET_URL.$data['australia-service-image']['url'] ?>" class="attachment-full size-full" alt="Export Australia" decoding="async" sizes="(max-width: 655px) 100vw, 655px" />
                                  </div>
                              </div>
                          </div>
                      </div>
