                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-5 col-lg-12 col-md-12 col-12">
                              <div class="inner p-t-md p-b-md">
                                  ...
                                  <p>Marlog Car Handling manages a large volume of exports to the United States.</p>
                              </div>
                          </div>
                          <div class="col-xl-6 offset-xl-1 col-lg-4 offset-lg-0 col-md-6 offset-md-1 p-r h-image">
                              <div class="inner p-r">
                                  <img width="945" height="400" src="<?php echo ASSET_URL; ?>img/export-delivery-countries-america-header.jpg" class="attachment-full size-full" alt="Export to America" decoding="async" fetchpriority="high" srcset="<?php echo ASSET_URL; ?>img/export-delivery-countries-america-header.jpg 945w, <?php echo ASSET_URL; ?>img/export-delivery-countries-america-header-300x127.jpg 300w, <?php echo ASSET_URL; ?>img/export-delivery-countries-america-header-768x325.jpg 768w" sizes="(max-width: 945px) 100vw, 945px" />
                              </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <div class="inner text p-md h-100 pl-0">
                                      <h2>RORO shipping to America</h2>
                                      <p>Marlog Car Handling manages a large volume of exports to the United States. We offer container transport and RoRo shipping facilities. We also offer a console service to New York. This means that we load several vehicles belonging to different owners into one container, in order to make transport cheaper. We have access to an extensive network of reliable agents who assist us in the export process to the United States.</p>
                                  </div>
                              </div>
                              <div class="col-lg-6">
